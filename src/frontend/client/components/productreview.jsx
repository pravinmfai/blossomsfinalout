...
const Productreview = () => {
  const allReviews = [
    ...
    { reviewid: 3, name: "Meenakshi V.", reviewdesc: "Cotton saree smooth ah iruku, daily wear ku best.", rating: 4, posteddate: "January 20, 2025" },
    ...
    { reviewid: 5, name: "Radha P.", reviewdesc: "Saree worth ah iruku", rating: 3.5, posteddate: "February 12, 2025" },
    ...
    { reviewid: 23, name: "Jaya P.", reviewdesc: "Wash la kooda color change illa", rating: 4, posteddate: "February 13, 2025" },
    { reviewid: 24, name: "Vaishnavi R.", reviewdesc: "Nice saree, perfect for daily use!", rating: 4.5, posteddate: "February 14, 2025" },
    { reviewid: 25, name: "Sangeetha T.", reviewdesc: "Good saree, nice quality, best buy", rating: 5, posteddate: "January 24, 2025" }
  ];
