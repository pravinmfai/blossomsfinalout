      ...
      <div className="footer-info">
        <div className="footer-left">
          ...
          <div className="footer-social">
            ...
            <a href="https://wa.me/917418603504?text=Hi!%20I%20found%20your%20boutique%20online%20and%20want%20to%20know%20more!" className="icon-circle" target="_blank" rel="noopener noreferrer"><i className="fab fa-whatsapp"></i></a>
            <a href="mailto:blossomsbotique.mfai@gmail.com" className="icon-circle"><i className="far fa-envelope"></i></a>
            <a href="https://www.instagram.com/blossomsboutique65" className="icon-circle" target="_blank" rel="noopener noreferrer"><i className="fab fa-instagram"></i></a>
          </div>
        </div>
      </div>

      {/* Footer Links - Moved Outside Footer Left */}
